        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Kg = table.Column<string>(type: "text", nullable: true),
                    RuHeader = table.Column<string>(type: "text", nullable: true),
                    EnHeader = table.Column<string>(type: "text", nullable: true),
                    KgHeader = table.Column<string>(type: "text", nullable: true),
                    RuDescription = table.Column<string>(type: "text", nullable: true),
                    EnDescription = table.Column<string>(type: "text", nullable: true),
                    KgDescription = table.Column<string>(type: "text", nullable: true),
                    UserId = table.Column<string>(type: "text", nullable: false),
                    PathGuid = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
